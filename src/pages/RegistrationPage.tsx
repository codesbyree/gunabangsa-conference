        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-emerald-100/80 p-8 rounded-3xl border border-emerald-200">
            <p className="text-slate-700 leading-relaxed font-medium">
              ...
              participation — Online and Onsite — to accommodate scholars from
              around the world. Registration is carried out through the IGERS
              system. Information about IGERS and the registration procedures
            ...
            {REGULAR_PRICING.map((section, idx) => (
              <div key={idx} className="flex flex-col gap-4">
                ...
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                  {section.tiers.map((tier: any, tIdx) => (
                    <PricingCard
                      key={tIdx}
                      cardTitle={tier.name}
            ...
            <article className="flex flex-col gap-8 p-10 bg-slate-100 border border-slate-200 rounded-[2.5rem]">
              ...
              <NumberedArticle
                items={[
                  ...
                  {
                    text: "Complete the participant form:",
                    subitems: [
                      "Select the conference",
                      "Choose the applicable participation category",
                    ],
                  },
                  {
        ...
        <div className="max-w-7xl mx-auto px-6 space-y-10">
          ...
          <div className="bg-amber-50/80 p-8 rounded-3xl border border-amber-200">
            <ul className="list-disc list-outside ml-5 space-y-4 text-amber-900/80 font-medium leading-relaxed">
              <li>
                <strong>Presenter (Online & Onsite):</strong> The registration
                fee does not cover the publication of accepted papers.
                <ul className="list-[circle] list-outside ml-5 mt-2 space-y-2">
                  <li>
                    <strong>Additional accepted papers:</strong> subject to an
                    extra fee of USD 375 / IDR 5.750.000 each.
                  </li>
                  <li>
                    <strong>Student Presenter:</strong> Must provide a valid
                    student ID.
                  </li>
                </ul>
              </li>
              <li>
                <strong>Participant (Non-Presenter):</strong> Entitled to full
                access to sessions and conference certificate.
                <ul className="list-[circle] list-outside ml-5 mt-2 space-y-2">
                  <li>
                    Onsite participants additionally receive seminar kit,
                    conference abstract e-book, coffee break and e-certificate
                    of participation.
                  </li>
                  <li>
                    <strong>Student Participant:</strong> Must provide a valid
                    student ID.
                  </li>
                </ul>
              </li>
