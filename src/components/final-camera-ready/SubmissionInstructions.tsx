    ...
    <div className="max-w-7xl mx-auto px-6 py-24 space-y-24">
      <section className="space-y-8">
        <div className="flex items-center gap-4 border-b border-slate-100 pb-8">
          ...
          <h2 className="text-lg lg:text-xl font-black text-red-950 tracking-tighter uppercase leading-tight">
            Final Camera-Ready Submission Instructions
          </h2>
        </div>
        <div className="bg-red-100 p-8 rounded-3xl border border-red-200">
      ...
      <section className="space-y-12">
        <div className="flex items-center gap-4 border-b border-slate-100 pb-8">
          <FileCode className="w-8 h-8 text-red-600" />
          <h3 className="text-2xl font-black text-red-950 tracking-tighter uppercase leading-tight">
        ...
        <div className="bg-slate-900 rounded-[3rem] p-10 md:p-14 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center justify-between">
            <div className="flex-1 max-w-2xl">
              <h4 className="text-red-500 text-[10px] font-black uppercase tracking-[0.3em] mb-4">Assistance</h4>
            ...
            <div className="flex flex-col gap-4 bg-white/10 p-8 rounded-3xl border border-white/10 w-full md:w-auto min-w-[300px]">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:nutral@nusaputra.ac.id" className="text-sm hover:text-red-400 transition-colors font-medium">
      ...
      <div className="space-y-10">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-base lg:text-lg font-black text-red-950 tracking-tighter uppercase leading-tight">Template Resources</h3>
        </div>
