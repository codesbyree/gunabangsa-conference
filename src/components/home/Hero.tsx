    ...
    <section className="relative min-h-dvh flex flex-col items-center justify-center bg-emerald-950 py-20 lg:py-30 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <button className="px-10 py-5 border border-white/20 text-white font-black text-sm uppercase tracking-widest rounded-md hover:bg-white/5 transition active:scale-95 flex items-center justify-center">
            Download Guidelines
          </button>
        </motion.div>
      </div>
