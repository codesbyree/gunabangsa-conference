  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Host & Co-Host */}
        <div className="mb-20">
          <h3 className="text-base font-bold text-center text-slate-800 mb-10 tracking-tight">
            Host & Co-Host
          </h3>
          <div className="flex flex-wrap justify-center gap-10 items-stretch">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-[9px] font-black text-slate-300 tracking-[0.3em] uppercase">
                  ×
                </span>
                <div className="w-px h-16 bg-slate-200" />
              </div>
        ...
        {/* Supporters */}
        <div className="mb-16">
          <h3 className="text-base font-bold text-center text-slate-800 mb-8 tracking-tight">
            Supporters
          </h3>
