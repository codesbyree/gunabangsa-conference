    ...
    <div className="max-w-7xl mx-auto px-6 py-24 space-y-10">
      <section className="space-y-12">
        <div className="flex items-center gap-4 border-b border-slate-100 pb-8">
          ...
          <h2 className="text-xl md:text-2xl lg:text-3xl font-black text-red-950 tracking-tighter uppercase">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <section className="flex flex-col gap-8 p-10 bg-slate-100 border border-slate-200 rounded-[2.5rem]">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-base md:text-lg font-extrabold text-red-950 uppercase tracking-tight">Creating an Account</h3>
          </div>
          <NumberedSteps items={[
        ...
        <section className="flex flex-col gap-8 p-10 bg-slate-100 border border-slate-200 rounded-[2.5rem]">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-base md:text-lg font-extrabold text-red-950 uppercase tracking-tight">Login to Your Account</h3>
          </div>
          <NumberedSteps items={[
      ...
      <section className="space-y-12">
        ...
        <div className="bg-red-950 text-white rounded-[3rem] p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            {[
              ...
              <div key={i} className="space-y-4">
                <div className="text-red-500 font-black text-4xl opacity-30">0{i + 1}</div>
                <p className="text-sm font-medium leading-relaxed text-red-100/70">{text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="space-y-10">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-base md:text-lg font-black text-red-950 tracking-tighter uppercase">Template Resources</h3>
        </div>
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            <a
              key={tmpl.title}
              href="#"
              className="flex items-center justify-between p-8 bg-white border border-slate-200 rounded-3xl hover:border-red-500 hover:shadow-xl transition-all group"
            >
              <div>
                <h4 className="font-bold text-red-950 mb-1">{tmpl.title}</h4>
                <p className="text-xs text-slate-400">{tmpl.subtitle}</p>
              </div>
              <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center text-slate-300 group-hover:bg-red-500 group-hover:text-white transition-all">
        ...
        <div className="bg-slate-900 rounded-[3rem] p-10 md:p-14 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h4 className="text-red-500 text-[10px] font-black uppercase tracking-[0.3em] mb-4">Submission Ethics</h4>
