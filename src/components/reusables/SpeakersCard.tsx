...
export default function SpeakersCard({
  ...
  return (
    <div className="group relative h-[560px] overflow-hidden rounded-xl bg-red-950 border border-slate-200">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[80%] bg-white translate-y-full transition-transform duration-500 ease-in-out group-hover:translate-y-0 p-8 flex flex-col z-20">
        <div className="flex items-center justify-between border-b border-slate-100 pb-6 mb-6">
          <div className="flex flex-col">
            <span className="text-red-600 text-[10px] font-black uppercase tracking-widest mb-1">
              Keynote Speaker
            </span>
            <h4 className="text-sm font-extrabold text-red-950 leading-tight">
              {name}
            </h4>
          </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar pr-2">
          <p className="text-xs font-bold text-red-700 uppercase mb-3 tracking-tighter">
            Academic Background
          </p>
          ...
          <div className="space-y-4">
            <div className="p-3 bg-slate-50 border-l-2 border-red-500">
